...
save_dir_path = results_path / 'plots' / 'training_record'
...
if fig_flgs['total_reward_record']:
    ...
    ax_total_reward.set_xlabel('Episode', fontsize=20, fontweight='bold')
    ax_total_reward.set_ylabel('Total Reward', fontsize=20, fontweight='bold')
    ax_total_reward.set_title('Total Reward Record (EMA)' if ema_flg else 'Total Reward Record', fontsize=24, fontweight='bold')
    ...
    fig_total_reward.savefig(save_dir_path / f"total_reward_record_{'ema' if ema_flg else 'raw'}.png")
...
if fig_flgs['epsilon_record']:
    ...
    ax_epsilon.set_xlabel('Episode', fontsize=20, fontweight='bold')
    ax_epsilon.set_ylabel('Epsilon', fontsize=20, fontweight='bold')
    ax_epsilon.set_title('Epsilon Record', fontsize=24, fontweight='bold')
    ...
    fig_epsilon.savefig(save_dir_path / "epsilon_record.png")
...
if fig_flgs['num_epochs_record']:
    ...
    ax_num_epochs.set_xlabel('Episode', fontsize=20, fontweight='bold')
    ax_num_epochs.set_ylabel('Num Epochs', fontsize=20, fontweight='bold')
    ax_num_epochs.set_title('Num Epochs Record', fontsize=24, fontweight='bold')
    ...
    fig_num_epochs.savefig(save_dir_path / "num_epochs_record.png")
...
if fig_flgs['update_interval_record']:
    ...
    ax_update_interval.set_xlabel('Episode', fontsize=20, fontweight='bold')
    ax_update_interval.set_ylabel('Update Interval', fontsize=20, fontweight='bold')
    ax_update_interval.set_title('Update Interval Record', fontsize=24, fontweight='bold')
    ...
    fig_update_interval.savefig(save_dir_path / "update_interval_record.png")
...
if fig_flgs['random_phase_probs_record']:
    ...
    ax_random_phase_probs.set_xlabel('Episode', fontsize=20, fontweight='bold')
    ax_random_phase_probs.set_ylabel('Random Phase Probability', fontsize=20, fontweight='bold')
    ax_random_phase_probs.set_title('Random Phase Probabilities Record', fontsize=24, fontweight='bold')
    ...
    fig_random_phase_probs.savefig(save_dir_path / "random_phase_probs_record.png")
