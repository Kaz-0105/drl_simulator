...
def main():
    ...
    # get save_dir_path
    save_dir_path = root_dir_path / 'data' / 'analysis' / 'performance_metric_stats' / 'multiple'
...
def saveOutliers(performance_metric_df, config_yaml, save_dir_path):
    ...
    for performance_metric, performance_metric_outlier_df in performance_metric_outlier_df_map.items():     
        ...
        performance_metric_outlier_df = performance_metric_outlier_df[['id', 'method', 'layout', 'inflow', 'value']]
